package bku.com.example.hello_worldspeak;
...
//        JSONArray = jsonObject.
    ...
    private void getDataFromThingSpeak() {
        ...
        Request request = builder.url("https://api.thingspeak.com/channels/867302/feeds.json?api_key=" + API_KEY_READ + "&results=1").build();
        counter++;
...
//                });
    ...
    private void sendDataToThingSpeak(int counter1, int counter2) {
        ...
        Request request = builder.url("https://api.thingspeak.com/update?api_key=" + API_KEY_WRITE + "&field1=" + c1 +"&field2=" +c2).build();
